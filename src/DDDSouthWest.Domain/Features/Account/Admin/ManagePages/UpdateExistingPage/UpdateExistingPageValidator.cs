...
namespace DDDSouthWest.Domain.Features.Account.Admin.ManagePages.UpdateExistingPage
{
    public class UpdateExistingPageValidator : AbstractValidator<Admin.ManagePages.UpdateExistingPage.UpdateExistingPage.Command>
    {
